...
<nav className="bg-white border-gray-200 dark:bg-gray-900">
  ...
  <a href="https://turnme.to" className="flex items-center space-x-3 rtl:space-x-reverse">
      <span className="font-reenie self-center text-4xl font-semibold whitespace-nowrap dark:text-white">turn me to</span>
  </a>
